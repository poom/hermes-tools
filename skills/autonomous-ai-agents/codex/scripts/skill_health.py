#!/usr/bin/env python3
"""Offline health checks for the codex skill package."""
...
def check_skill(root: Path) -> list[str]:
    ...
    if 'name: codex' not in text:
        errors.append('frontmatter name must be codex')
...
def main() -> int:
    parser = argparse.ArgumentParser(description='Validate codex skill support files.')
