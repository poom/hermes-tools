# Preserved Codex CLI Guide

This reference preserves the previous detailed operating guide. Use it for step-by-step commands and edge cases after the lean protocol in `SKILL.md` selects this skill.
...
terminal(command="codex exec --full-auto 'Refactor the auth module'", workdir="<home>/project", background=true, pty=true)
# Returns session_id
