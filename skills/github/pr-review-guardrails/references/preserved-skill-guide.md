# Preserved PR Review Guardrails Guide
...
- Prefer the Linear CLI or this skill's helper over ad-hoc `curl | python` / custom GraphQL Python snippets. In Hermes sessions, those ad-hoc pipelines can trigger approval prompts repeatedly. Approved patterns:
  ...
  # Helper; loads <home>/.hermes/.env, calls linear CLI, and emits prompt-ready Markdown.
...
- If no project directory is available: `${HERMES_HOME:-<home>/.hermes}/pr-reviews/<repo>-<pr-number>.md`
