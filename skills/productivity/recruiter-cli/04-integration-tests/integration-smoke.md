...
Expected result: the command prints `recruiter-cli skill health ok`. If live credentials are absent, skip live side effects and keep this structural check as the integration baseline.
