...
description: Use when applying the Pre-Commit Code Verification skill workflow: Pre-commit review: security scan, quality gates, auto-fix. Triggered by requests mentioning requesting-code-review, Pre-Commit Code Verification, setup, operation, troubleshooting, review, or automation for this workflow.
version: 2.0.0
license: MIT
metadata:
  hermes:
...
1. Use this skill only when the user request matches the trigger description or explicitly names `requesting-code-review`.
