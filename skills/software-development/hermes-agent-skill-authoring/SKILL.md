...
description: Use when applying the Authoring Hermes-Agent Skills (in-repo) skill workflow: Author in-repo SKILL.md: frontmatter, validator, structure. Triggered by requests mentioning hermes-agent-skill-authoring, Authoring Hermes-Agent Skills (in-repo), setup, operation, troubleshooting, review, or automation for this workflow.
version: 1.0.0
license: MIT
metadata:
  hermes:
...
1. Use this skill only when the user request matches the trigger description or explicitly names `hermes-agent-skill-authoring`.
...
- [Importing Openclaw Skills](references/importing-openclaw-skills.md) - preserved detailed guidance or domain-specific operations.
